  ...
  return (
    ...
    <section id='contact'> 
      ...
      <ul>
                        ...
                        <li class="list-inline-item"><a href="FurnessPorfolioResume_2022.pdf" target="blank"><img class="img-fluid rounded mb-4 mb-lg-0" src={process.env.PUBLIC_URL + '/resume.png'}
