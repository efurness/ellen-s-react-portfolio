...
<ul>
                        ...
                        <li class="list-inline-item zoom"><a href="EDF_Resume_2023new.pdf" target="blank"><img class="img-fluid rounded mb-4 mb-lg-0" src={process.env.PUBLIC_URL + '/resume.png'}
